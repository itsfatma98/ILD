...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="">
        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                ...
                <div class="card">
                    <div class="image-content" style="background-image: url(img/printer1.jpg); background-repeat: no-repeat; background-position: center center; background-size: cover;">
                    </div>
            ...
            <div class="swiper-slide">
                <div class="card">
                    <div class="image-content" style="background-image: url(img/proc2.jpg); background-repeat: no-repeat; background-position: center center; background-size: cover;">
                    </div>
            ...
            <div class="swiper-slide">
                <div class="card">
                    <div class="image-content" style="background-image: url(img/holo.jpg); background-repeat: no-repeat; background-position: center center; background-size: cover;">
                    </div>
            ...
            <div class="swiper-slide">
                <div class="card">
                    <div class="image-content" style="background-image: url(img/vvvr.jpg); background-repeat: no-repeat; background-position: center center; background-size: cover;">
                    </div>
    ...
    <p class="append-buttons">
        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="card">
                    <div class="image-content" style="background-image: url(img/OIP.jpg); background-repeat: no-repeat; background-position: center center; background-size: cover;">
                    </div>
            ...
            <div class="swiper-slide">
                <div class="card">
                    <div class="image-content" style="background-image: url(img/leap-motion.jpg); background-repeat: no-repeat; background-position: center center; background-size: cover;">
                    </div>
